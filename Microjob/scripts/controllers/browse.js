...
app.controller('BrowseController', function ($scope, $routeParams, toaster, Task, Auth, Comment, Offer) {
	...
	$scope.fntab1 = function () {
	    $("#tabpan-01").addClass("active");
	    $("#tabpan-02").removeClass("active");
	    $("#tabpan-03").removeClass("active");
	    $("#tabpan-04").removeClass("active");
	}

	$scope.fntab2 = function () {
	    $("#tabpan-02").addClass("active");
	    $("#tabpan-01").removeClass("active");
	    $("#tabpan-03").removeClass("active");
	    $("#tabpan-04").removeClass("active");
	}

	$scope.fntab3 = function () {
	    $("#tabpan-01").removeClass("active");
	    $("#tabpan-02").removeClass("active");
	    $("#tabpan-03").addClass("active");
	    $("#tabpan-04").removeClass("active");
	}

	$scope.fntab4 = function () {
	    $("#tabpan-01").removeClass("active");
	    $("#tabpan-02").removeClass("active");
	    $("#tabpan-03").removeClass("active");
